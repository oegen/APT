<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PDFAnnotateTask.aspx.vb" Inherits="Task_PDFAnnotateTask" Title="PDF Annotation Task" MasterPageFile="~/MasterPages/TabPageWithoutAjax.master" %>
<%@ Register Src="~/Controls/Tasks/PDFAnnotateTask.ascx" TagName="PDFAnnotateTask" TagPrefix="oegen"  %>
...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    ...
    <div class="tabswrap">
        ...
        <div id="tabs-inner" class="group">  
            ...
            <oegen:PDFAnnotateTask ID="ctrlAnnotateTask" runat="server" />
