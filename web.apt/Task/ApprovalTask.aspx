<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ApprovalTask.aspx.vb" Inherits="Task_ApprovalTask" Title="Project Approval Task" MasterPageFile="~/MasterPages/TabPageWithoutAjax.master" %>
<%@ Register Src="~/Controls/Tasks/ApprovalTask.ascx" TagName="ApprovalTask" TagPrefix="oegen"  %>
...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    ...
    <div class="tabswrap">
        ...
        <div id="tabs-inner" class="group">  
            ...
            <oegen:ApprovalTask ID="ctrlApprovalTask" runat="server" />
