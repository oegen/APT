...
Partial Class Task_ElementTask
...
#Region "Events"
    ...
    Protected Sub ctrlElementTask_TaskComplete(ByVal sender As Object, ByVal e As System.EventArgs) Handles ctrlElementTask.TaskComplete
        Dim currentToken As Token = WorkflowManager.GetTokenByID(ctrlElementTask.TokenId)
...
#Region "Private Implementation"
    ...
    Private Sub SetupPage()
        ...
        If Integer.TryParse(Request.QueryString(QUERY_ID), tokenId) Then
            ctrlElementTask.TokenId = tokenId
