...
#Region "Events"
    ...
    Protected Sub ctrlBriefTask_TaskComplete(ByVal sender As Object, ByVal e As System.EventArgs) Handles ctrlBriefTask.TaskComplete
        Dim currentToken As Token = WorkflowManager.GetTokenByID(ctrlBriefTask.TokenId)
