<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ElementTask.aspx.vb" Inherits="Task_ElementTask" Title="Element Task Completion" MasterPageFile="~/MasterPages/TabPageWithoutAjax.master" %>
<%@ Register Src="~/Controls/Tasks/ElementTask.ascx" TagName="ElementTask" TagPrefix="oegen"  %>
...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    ...
    <div class="tabswrap">
        ...
        <div id="tabs-inner" class="group">  
            ...
            <oegen:ElementTask ID="ctrlElementTask" runat="server" />
