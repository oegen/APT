<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Tag.aspx.vb" Inherits="Admin_Tags_Tag" Title="Add / Edit Tag" 
...
<%@ Register Src="~/Controls/Admin/Tags/Tag.ascx" TagName="Tag" TagPrefix="oegen" %>
...
<div id="maincontent" class="group">
    ...
    <div id="content" class="group">
        ...
        <!--PROJECT LIST STARTS-->
            <hr />
            <div id="gen-inner">
                <oegen:GenericTitle ID="ctrlGenericTitle" runat="server" TipTitle="Add/Edit New Tag" Description="Tag Management" />  
                <!--  GENERIC FORM -->                             
                <div class="aptform gen-form">
                    <oegen:Tag ID="ctrlTag" runat="server" />
                </div>                        
                <!--  END GENERIC FORM -->          
                <!--PROJECT LIST ENDS--> 
            </div>              
